 ...
 * METER.multiply(0.3048); MILLISECOND = MILLI(SECOND); [/code]
 * </p>
 * 
 * <p>
 * Transformed units have no label. But like any other units, they may have
 * labels attached to them:[code] UnitFormat.getStandardInstance().label(FOOT,
 * "ft"); [/code] or aliases: [code]
