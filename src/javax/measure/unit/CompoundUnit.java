 ...
 * 
 * <p>
 * Examples of compound units:[code] Unit<Duration> HOUR_MINUTE_SECOND =
 * HOUR.compound(MINUTE).compound(SECOND); Unit<Angle> DEGREE_MINUTE_ANGLE =
...
public final class CompoundUnit<Q extends Quantity> extends DerivedUnit<Q> {
	 ...
	 */
	CompoundUnit(final Unit<Q> high, final Unit<Q> low) {
	 ...
	 * object (both are compound units with same composing units in the same
	 * order).
	 *
	 * @param that
	...
	public boolean equals(final Object that) {
		...
		if (!(that instanceof CompoundUnit))
			return false;
		final CompoundUnit<?> thatUnit = (CompoundUnit<?>) that;
