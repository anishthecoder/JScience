...
public abstract class Measure<V, Q extends Quantity> implements Measurable<Q>,
	 ...
	 * specified unit. This method may result in lost of precision (e.g. measure
	 * of integral value).
	 * 
	 * @param unit
	 ...
	 * <code>double</code>. If the measure has too great a magnitude to be
	 * represented as a <code>double</code>, it will be converted to
	...
	/**
	 * Returns the estimated integral value of this measure stated in the
	 * specified unit as a <code>long</code>.
	 * 
	 * <p>
	 * Note: This method differs from the <code>Number.longValue()</code> in the
	 * sense that the closest integer value is returned and an
	 * ArithmeticException is raised instead of a bit truncation in case of
	 * overflow (safety critical).
	 * </p>
	 * 
	 * @param unit
	 ...
	 *         if this quantity cannot be represented as a <code>long</code>
	...
	/**
	 * Returns the estimated integral value of this measure stated in the
	 * specified unit as a <code>int</code>.
	 * 
	 * <p>
	 * Note: This method differs from the <code>Number.intValue()</code> in the
	 * sense that the closest integer value is returned and an
	 * ArithmeticException is raised instead of a bit truncation in case of
	 * overflow (safety critical).
	 * </p>
	 ...
	 * @throws ArithmeticException
	 *         if this quantity cannot be represented as a <code>int</code>
	 *         number in the specified unit.
	 */
	 ...
	 * @return <code>true</code> if both objects are identical (same unit and
	 *         same amount); <code>false</code> otherwise.
	 */
	@Override
	...
	/**
	 * Returns the <code>String</code> representation of this measure The string
	 * produced for a given measure is always the same; it is not affected by
	 * locale. This means that it can be used as a canonical string
	 * representation for exchanging data, or as a key for a Hashtable, etc.
	...
	/**
	 * Compares this measure to the specified measurable quantity. This method
	 * compares the {@link Measurable#doubleValue(Unit)} of both this measure
	 * and the specified measurable stated in the same unit (this measure's
	 * {@link #getUnit() unit}).
	 * 
	...
	private static final class Double<Q extends Quantity> extends
		...
		/**
		 * Private constructor added to allow serialization libraries like Kryo
		 * to save / load objects of this type.
		 */
		@SuppressWarnings("unused")
		private Double() {
			_value = java.lang.Double.NaN;
			_unit = null;
		}
